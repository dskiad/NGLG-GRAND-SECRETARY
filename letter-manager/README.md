...
## Ξεχωριστή ροή Διαταγμάτων

Τα **Διατάγματα δεν αποτελούν επιστολές** και δεν χρησιμοποιούν πλέον τη ροή, το αρχείο ή το PDF των επιστολών.

- **Νέα Επιστολή** → αποθηκεύεται αποκλειστικά στο Αρχείο Επιστολών και παράγει PDF επιστολής.
- **Νέο Διάταγμα** → αποθηκεύεται σε ανεξάρτητο αρχείο Διαταγμάτων και παράγει ξεχωριστό PDF Διατάγματος.
- Το πρότυπο «ΔΙΑΤΑΓΜΑΤΑ» έχει αφαιρεθεί από τη λίστα προτύπων επιστολών.
- Τα παλαιά Διατάγματα που είχαν δημιουργηθεί μέσα στη δομή των επιστολών μεταφέρονται αυτόματα στο ανεξάρτητο αρχείο Διαταγμάτων και δεν εμφανίζονται πλέον στο Αρχείο Επιστολών.
- Το Διάταγμα χρησιμοποιεί τον δικό του αριθμό, ημερομηνία, περιεχόμενο, κατάσταση, παραλήπτες και αρχείο PDF.
- Νέες διαδρομές:
  - `/decrees/new` — Νέο Διάταγμα
  - `/decrees/archive` — Αρχείο Διαταγμάτων
  - `/decrees/{id}` — Προβολή Διατάγματος
  - `/decrees/{id}/pdf` — PDF Διατάγματος
