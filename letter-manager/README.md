...
Η επίσημη υπογραφή περιλαμβάνει μπλε γραμμή θέσης υπογραφής, ο τίτλος εμφανίζεται ως **Ο Μέγας Γραμματέας** με έντονο σκούρο μπλε, και η σφραγίδα εμφανίζεται με διάμετρο αυξημένη κατά 2 cm, με το κέντρο της στο ίδιο οριζόντιο επίπεδο με τη λεπτή μπλε γραμμή της υπογραφής.
...
- **Νικόλαος Χατζηδημητρίου** — οι νέες επιστολές αποθηκεύονται με υπογράφοντα τον **Ο Αν. Μέγας Γραμματέας** και το όνομα **Λίαν Σεβάσμιος Αδ. Νικόλαος Χατζηδημητρίου**.
