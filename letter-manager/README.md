...
Η επίσημη υπογραφή περιλαμβάνει μπλε γραμμή θέσης υπογραφής, ο τίτλος εμφανίζεται ως **Ο Μέγας Γραμματέας** με έντονο σκούρο μπλε, και η σφραγίδα εμφανίζεται με διάμετρο αυξημένη κατά 2 cm.
